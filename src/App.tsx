...
const translations = {
  hero: {
    ...
    name: 'တောင်းပန်ပါတယ်မမရယ် Valentine dayမှာ သူများတွေလို luxury brandတွေမဝယ်ပေးနိုင်သေးပေမဲ့ မောင်တတ်နိုင်တဲ့အချစ်တွေပါတဲ့ဒါလေးလက်ဆောင်ပေးမယ်နော်...',
    scrollHint: 'မောင့်အချစ်တွေကို တဖြည်းဖြည်းချင်းဆွဲကြည့်နော်💕'
  },
  ourStory: {
    ...
    moments: [
      ...
      { caption: 'အကြည့်တွေနဲ့ ကောင်မလေးကိုသိမ်းထားတာ', icon: Smile },
      { caption: 'မမ မရှိတဲ့မောင့်အနာဂတ် မှောင်မဲ', icon: Video },
      { caption: 'အိပ်နေတာကို အာဘွားခိုးပေးတာနော်', icon: Heart },
      { caption: 'စျေးဝယ်တုန်းကတူတူ', icon: Star },
      { caption: 'လှတယ်ဆိုလို့ snapလေးတစ်ဖြတ်', icon: Gift },
      { caption: 'အမြဲချစ်တယ်', icon: Music },
      { caption: 'ကဲ ဘာတတ်နိုင်သေးလဲဆိုတဲ့အထာ', icon: Camera }
    ]
  },
  gallery: {
  ...
  letter: {
    ...
    subtitle: 'နှလုံးသားလေးကို နှိပ်ပြီး ဖွင့်ကြည့်ပါ 💝',
...
const allPhotos = [
  ...
  { src: '/images/photo2.jpg', caption: 'စော်ကြည်ဘဲလေးပေါ့' },
  ...
  { src: '/images/new3.jpg', caption: 'အလုပ်လုပ်နေတာကို အတင်းတွေနော်' },
